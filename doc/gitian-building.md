...
*Setup instructions for a Gitian build of Infinitecoin using a Debian VM or physical system.*
...
- [Building Infinitecoin](#building-infinitecoin)
...
Clone the git repositories for infinitecoin and Gitian and then checkout the infinitecoin version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the infinitecoin repository
under 'Fetch and build inputs' to install sources which require manual intervention. Also follow
the next step: 'Seed the Gitian sources cache', which will fetch all necessary source files allowing
for Gitian to work offline.

Building Infinitecoin
----------------

To build Infinitecoin (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md) in the infinitecoin repository.
...
For example:
```bash
URL=https://github.com/user/infinitecoin.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/infinitecoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/infinitecoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/infinitecoin-build.assert
```
...
[infinitecoin/gitian.sigs](https://github.com/infinitecoin-project/gitian.sigs.ifc/) repository, or if that's not possible create a pull
request. 
